...
exports.default = series(clean, parallel(html, css, js, jsLibs, assets, fonts, images), parallel(serve, watchFiles));
exports.build = series(clean, parallel(html, css, js, jsLibs, assets, fonts, images));
